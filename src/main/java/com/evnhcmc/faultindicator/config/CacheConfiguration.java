package com.evnhcmc.faultindicator.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("faultindicator");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("faultindicator");
        ...
        config.getMapConfigs().put("com.evnhcmc.faultindicator.domain.*", initializeDomainMapConfig(jHipsterProperties));
